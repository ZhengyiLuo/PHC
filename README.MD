...
[December 10, 2024] Release process for generating offline dataset for offline RL or behavior cloning (developed by @kangnil). See [docs/offline_dataset.md](docs/offline_dataset.md) for more details. 
