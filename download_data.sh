mkdir sample_data
mkdir -p output output/release output/phc_kp_pnn_iccv output/phc_kp_mcp_iccv output/phc_shape_mcp_iccv output/phc_shape_pnn_iccv
...
gdown https://drive.google.com/uc?id=1lROeTwUwZkhzs-NCfzvhFoyJvdy1chPu -O  output/phc_kp_pnn_iccv/
